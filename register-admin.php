...
>
  <head>
    ...
    <title>Resgistrasi Admin</title>

    <meta name="description" content="" />

    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="assets/img/favicon/bokori.ico" />
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            ...
            <?php 
              ...
              ?>
              <div>
                <h7><a href="account.php">KEMBALI</a></h7>
              </div>
              ...
              <!-- /Logo -->
              <p class="mb-4">Tambahkan Akun Admin</p>

              <form class="mb-3" action="autentikasi.php?act=register-admin" method="POST">
                <div class="mb-3">
