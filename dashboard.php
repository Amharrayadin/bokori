...
>
  <head>
    ...
    <title>Dashboard Penyebrangan Bokori</title>
  ...
  <body>
  <i class="fa-light fa-sailboat"></i>
    <!-- Layout wrapper -->
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="tabel-penyeberangan.php" class="menu-link">
                ...
                <!--<i class="menu-icon tf-icons bx bx-sea"></i>-->
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">            
              <center>
                ...
                <img src="assets/images/logobiru2.png" alt="bokori" widht="100px">
                <h3>DASHBOARD APLIKASI PEMEMESANAN TIKET PENYEBERANGAN <br>PULAU BOKORI</h3>
              </center>
              <hr class="my-5" />
