        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            ...
            <?php 
              ...
              <!-- /Logo -->
              <h4 class="mb-2">Selamat datang Di Pulau Bokori</h4>
              <p class="mb-4">Silahkan Masukkan Akun Pengguna Anda</p>

              <form class="mb-3" action="autentikasi.php?act=login" method="post">
                <div class="mb-3">
                ...
                <div class="mb-3">
                  <input class="btn btn-primary d-grid w-100" type="submit" name="login" value="Masuk"></input>
                </div>
              </form>
