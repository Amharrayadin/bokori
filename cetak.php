...
$pdf->SetFontSize(12);
$pdf->Cell(200, 5, 'STRUK PEMBAYARAN', 0, 1, 'C');
...
$pdf->Cell(7, 5, '', 0, 1);
$pdf->setX(10);
$pdf->Cell(5, 5, 'LOKASI       : ', 0, 0);
$pdf->setX(40);
$pdf->Cell(10, 5, $data[15], 0, 1);
$pdf->setX(10);
$pdf->Cell(10, 5, 'KONTAK     :', 0, 0);
$pdf->setX(40);
$pdf->Cell(0, 5, $data[16], 0, 1);
...
$pdf->Cell(5, 5, 'STATUS PEMBAYARAN : SELESAI', 0, 1);

$pdf->SetFont('Courier', '', 12);
$pdf->Cell(5, 7, 'ADMIN', 0, 1);
$pdf->Cell(5, 10, 'TTD', 0, 1);
$pdf->Cell(5, 7, $data[5], 0, 1);
