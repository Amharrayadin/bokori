...
if ($_GET['act'] == 'delete') {
  ...
  if ($query) {
    header(
      'Location:tabel-penyeberangan.php?pesan=Riwayat Pesananan Penyeberangan Berhasil Dihapus&alert=alert-success'
    );
  }
}
...
if ($_GET['act'] == 'beli') {
  ...
  if ($jumlah_stok >= $jumlah_penyeberangan) {
    $sqlpesan = "INSERT INTO tb_penyeberangan (nik, id_stok, harga, jumlah_penyeberangan, total_harga, status_penyeberangan) 
                  VALUES('$nik', '$id_stok', '$harga', '$jumlah_penyeberangan', '$total_harga','0')";
