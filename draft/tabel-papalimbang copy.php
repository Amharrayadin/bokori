        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tabel /</span> Tabel Papalimbang</h4>
                          ...
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="modalCenterTitle">Tambah Papalimbang</h5>
                                <button
                                  type="button"
                                  class="btn-close"
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                      ...
                                      <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                          ...
                                          <input
                                            ...
                                            placeholder="Masukan NIK Papalimbang"
                                            aria-label="Masukan NIK Papalimbang"
                                      ...
                                      <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                          ...
                                          <input
                                            ...
                                            placeholder="Masukan Nama Papalimbang"
                                            aria-label="Masukan Nama Papalimbang"
                                      ...
                                      <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                          ...
                                          <input
                                            ...
                                            class="form-control"
                                            placeholder="Masukan Alamat Papalimbang"
                                            aria-label="Masukan Alamat Papalimbang"
                                      ...
                                      <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                          ...
                                          <input
                                            ...
                                            placeholder="Masukan No Telepon Papalimbang"
                                            aria-label="Masukan No Telepon Papalimbang"
                                  ...
                                  <?php
                                    ...
                                    if(isset($_POST['tambah'])){
                                      ...
                                      if($query){
                                        header("Location:tabel-papalimbang.php?pesan=Artikel Berhasil Ditambahkan");
                                      }
                                    }                           
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              ...
                              >
                              <a class="dropdown-item" href="delete-papalimbang.php?nik_papalimbang=<?php echo $data[0]; ?>"
