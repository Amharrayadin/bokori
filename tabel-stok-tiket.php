        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tiket /</span> Stok Tiket</h4>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              ...
                              >
                              <a class="dropdown-item" href="act-tiket.php?act=delete-stok&id_stok=<?php echo $data[0]; ?>"
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="modalCenterTitle">Tambah Stok Tiket</h5>
                              <button
                                type="button"
                                class="btn-close"
                            ...
                            <div class="modal-body">
                              <div class="row">
                              <form action="act-tiket.php?act=create-stok" method="post" enctype="multipart/form-data">
                                  <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                      <div class="input-group input-group-merge">
                                        ...
                                        <input
                                          ...
                                          id="tgl_stok"
                                          name="tgl_stok"
                                          placeholder="Masukan Tanggal Tiket"
                                          aria-label="Masukan Tanggal Tiket"
                                    ...
                                    <div class="col-sm-10">
                                      <div class="input-group input-group-merge">
                                        ...
                                        <input
                                          ...
                                          aria-label="Masukan Jumlah Stok"
